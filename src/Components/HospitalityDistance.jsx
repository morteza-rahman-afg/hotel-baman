function HospitalityDistance() {
  return (
    <div className="w-full h-auto bg-slate-100 mt-12 rounded-2xl px-4 pb-5 pt-5 flex flex-col items-start gap-y-3">
...
export default HospitalityDistance;
